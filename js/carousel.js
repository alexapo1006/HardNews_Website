   ...
   */
	...
	Zippy.prototype._direction = function(e){
		...
		if (typeof e !== 'undefined'){
			direction = (typeof e.data === 'undefined' ? 'left' : e.data.direction);
		} else {
			direction = 'left';
		}
		return direction;
...
var args = {
	...
	slideDuration : 30000 //The amount of time between animations (milliseconds)
};
